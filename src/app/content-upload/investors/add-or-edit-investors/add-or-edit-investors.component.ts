...
export class AddOrEditInvestorsComponent implements OnInit{
  ...
  addeditInvestorItem(){
    if(this.addEditInvestorItemForm.valid){
      if(this.datas){
        const editPartnerData : editInvestor = {
          id : this.datas.id,
        ...
        const addInvestorsData : addInvestor = {
          title : this.addEditInvestorItemForm.controls['title'].value,
          link : this.addEditInvestorItemForm.controls['link'].value,
          imageFile : this.addEditInvestorItemForm.controls['imageFile'].value
        }
        this.addInvestorsForm(addInvestorsData)
      }
    }
  }

  addInvestorsForm(data: any){
    ...
    this.appService.addInvestors(formData).subscribe({
      next:(res)=>{
        this.closeModal();
        this.success = true;
        this.err = false;
